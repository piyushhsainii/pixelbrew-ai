...
const ReviewComponent = ({ user }: { user: any }) => {
    ...
    return (
        <form onSubmit={addReview} className=''>
            ...
            <section className="relative h-[60vh]  md:h-[45vh]  flex flex-col md:flex-row w-full px-10 bg-black justify-evenly items-center pb-4">
            ...
            <div className='bg-black '>
                <div className='bg-black flex justify-end m-auto relative right-[10.4rem] pb-5'>
                    <button
                        type='submit'
