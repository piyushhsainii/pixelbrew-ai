...
const DashboardNavbar = () => {
    ...
    console.log(params)
    return (
        <div className=" h-auto w-screen bg-black font-sans text-white ">
            <div className="flex justify-start gap-5 p-4 border border-purple-700 border-opacity-40  mt-16 text-purple-400 max-w-[1600px] m-auto" >
