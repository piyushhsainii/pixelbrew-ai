            ...
            {!editMode &&
                <div className="flex flex-col lg:flex-row justify-evenly items-center p-5 bg-black border border-white border-opacity-30 rounded-lg ">
                    ...
                    <div className="text-gray-300 font-sans w-[100%] lg:w-[40%] flex flex-col border border-gray-700 border-opacity-40 p-2">
                        <div>
                            <div className="flex justify-between bg-primmaryColor bg-opacity-80 items-center px-2 ">
                            ...
                            <div className="bg-primmaryColor bg-opacity-40 p-4 text-gray-200  tracking-tight text-sm ">
                        ...
                        <div className="flex flex-col gap-4 mt-3 ">
                            <div>
                                <div className="flex">
                                    <div className="bg-primmaryColor bg-opacity-80 p-2 font-semibold w-[50%] " >
                                        Resolution
                                    </div>
                            ...
                            <div>
                                <div className="flex ">
                                    ...
                                    <div className="bg-primmaryColor bg-opacity-40 p-2 text-gray-300 w-[50%] flex items-center text-sm">
                        ...
                        <div className="flex items-center gap-4">
                            <div onClick={() => seteditMode((e) => !e)}>
                                <ShadowBtn string="Customise" bgColor="bg-primmaryColor hover:bg-white shadow-none hover:text-black" />
                            </div>
                            <a href={Response.data[0].url} download={Response.data[0].url} target="blank">
                                <DownloadButton
                                    ...
                                    className="bg-white text-center text-black rounded-md  py-4 m-3 ml-0 flex items-center justify-evenly gap-1
